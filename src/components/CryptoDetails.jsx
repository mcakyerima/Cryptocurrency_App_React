...
import { Col, Raw , Typography , Select } from 'antd';
...
const CryptoDetails = () => {
    // use params allows you to use part of your URL's as a variable.. here we are using our coinID in the param and destructuring
    ...
    return (
        <Col className="coin-detail-container">
            <Col className='coin-heading-container'>
                ...
                <p>
                    {cryptoDetails.name} live Prive in US Dollars.
